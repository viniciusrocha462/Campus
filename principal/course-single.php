...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(../assets/images/html.jpg);">
      <div class="container">
            ...
            <div class="mb-5 element-animate">
              <div class="row align-items-center">
                <div class="col-md-8">
                  ...
                  <p class="lead mb-5">Curso completo sobre HTML 5</p>
                  
                  <p><a href="#" class="btn btn-primary mr-2">Começar Curso</a> <a href="#" class="btn btn-outline-white">Assistir mais tarde</a></p>
                </div>
                <div class="col-md-4">
                  <img src="../assets/images/html.jpg" alt="Image placeholder" class="img-fluid">
                </div>
              </div>
            </div>
