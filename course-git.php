...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/git.jpg);">
      <div class="container">
          ...
          <div class="col-md-12">
            ...
            <div class="mb-5 element-animate">
              <div class="row align-items-center">
                ...
                <div class="col-md-4">
                  <img src="images/git.jpg" alt="Image placeholder" class="img-fluid">
                </div>
              </div>
            </div>
